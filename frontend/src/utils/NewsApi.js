...
export default class NewsApi extends BaseApi {
  ...
  search(keyword) {
    ...
    //For the intent and purpose of this project, at this stage, I don't feel it's necessary to modify the api call to do much more than the defaults my account is configured for anyways.
